...
:RenameandDownloadLatestStevenBlackHostsFile
	...
	ren "C:\Windows\System32\drivers\etc\hosts.file" "Backup - hosts - [%random%].file" >nul
	
	echo.
	echo.

	Echo  Downloading Hosts File To  "C:\Windows\System32\drivers\etc\"
	powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/fakenews-gambling-social/hosts -OutFile C:\Windows\System32\drivers\etc\hosts.file"
